...
data = pd.read_csv('JeremyTheresa_tweets_new_out_utf8.csv', delimiter=",", quotechar="'", error_bad_lines=False)
data.head(5)
...
output.to_csv('outputJeremyTheresaLex.csv', encoding='utf-8')
